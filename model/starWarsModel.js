...
const search = search => fetch(`http://localhost:3000/starWars?name_like=${search}`).then(response => response.json());

const remove = id => fetch(`http://localhost:3000/starWars/${id}`, { method: "DELETE" });
