!(function (r, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(["exports"], e)
        : e(((r = "undefined" != typeof globalThis ? globalThis : r || self).uuid = {}));
})(this, function (r) {
    "use strict";
    var e,
        n = new Uint8Array(16);
            ...
            (function (r, e) {
                ...
                for (var n = 1732584193, t = -271733879, o = -1732584194, a = 271733878, i = 0; i < r.length; i += 16) {
                    ...
                    (n = m(n, t, o, a, r[i], 7, -680876936)),
                        ...
                        (n = w(n, (t = m(t, o, a, n, r[i + 15], 22, 1236535329)), o, a, r[i + 1], 5, -165796510)),
                        ...
                        (n = b(n, (t = w(t, o, a, n, r[i + 12], 20, -1926607734)), o, a, r[i + 5], 4, -378558)),
                        ...
                        (n = A(n, (t = b(t, o, a, n, r[i + 2], 23, -995338651)), o, a, r[i], 6, -198630844)),
    ...
    var R = p("v5", 80, function (r) {
        ...
        for (var a = r.length / 4 + 2, i = Math.ceil(a / 16), u = new Array(i), f = 0; f < i; ++f) {
            for (var s = new Uint32Array(16), c = 0; c < 16; ++c)
                s[c] = (r[64 * f + 4 * c] << 24) | (r[64 * f + 4 * c + 1] << 16) | (r[64 * f + 4 * c + 2] << 8) | r[64 * f + 4 * c + 3];
            u[f] = s;
        }
    ...
    (r.NIL = "00000000-0000-0000-0000-000000000000"),
        ...
        (r.v1 = function (r, e, n) {
            ...
            var p = void 0 !== r.msecs ? r.msecs : Date.now(),
                ...
                y = p - l + (h - d) / 1e4;
            if ((y < 0 && void 0 === r.clockseq && (s = (s + 1) & 16383), (y < 0 || p > l) && void 0 === r.nsecs && (h = 0), h >= 1e4))
