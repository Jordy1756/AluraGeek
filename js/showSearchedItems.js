...
const showArticles = artciles => {
    const container = document.querySelector(".articles-container");
    artciles.forEach(({ id, image, name, price }) => {
        const article = `
        <article class="article">
            ...
            <a class="article-link" href="../html/showArticle.html?category=${artciles.name}&id=${id}">Ver producto</a>
        </article>`;
...
showArticles(articles.consoles);
showArticles(articles.starWars);
showArticles(articles.various);
